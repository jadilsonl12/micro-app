...
import { GearIcon, LockClosedIcon, RocketIcon } from "@radix-ui/react-icons"
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button variant="link" className="relative h-8 items-center justify-between w-full space-x-2 !px-0">
